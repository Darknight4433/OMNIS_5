...
SCHOOL_METADATA = [
    ...
    {'answer': ["Dr P K Sukumaran"], 'question_data': ['founder', 'founder', 'mgm', 'founded']},
    ...
    {'answer': ['Dr Pooja S'], 'question_data': ['our', 'principal', 'principal', 'pooja', 'pooja']},
    ...
    {'answer': ["Dr A P J Abdul Kalam"], 'question_data': ['kalam', 'abdul', 'visit', 'mgm']},
    ...
    {'answer': ["Shri Oommen Chandy"], 'question_data': ['oommen', 'oommen', 'chandy', 'chandy', 'visit', 'visited']},
